...
function base16-everforest -d "Everforest"
  ...
  set -U fish_color_autosuggestion 4a555b
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 4a555b
  ...
  set -U fish_color_search_match bryellow --background=4a555b
  set -U fish_color_selection white --bold --background=4a555b
